...
# --- Admin: Kanal qo'shish, o'chirish, ro'yxat, statistika --- #
...
# --- Guruhdagi xabarlar: majburiy obuna tekshirish --- #
...
async def group_handler(_, m):
    ...
    if ok:
        return  # Foydalanuvchi obuna bo'lgan, xabar o'chirilmaydi
    ...
    try:
        await app.restrict_chat_member(
            ...
            permissions=ChatPermissions(),  # Hech nima yozolmaydi
        )
    except:
        pass
